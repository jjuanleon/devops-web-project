...
from typing import TYPE_CHECKING, Generator, Iterator, List, Optional, Sequence, Tuple, cast
...
class ListCommand(IndexGroupCommand):
    ...
    def pip_version_check(self, options: Values, args: List[str]) -> Iterator[None]:
        # Only run the version check when listing outdated/uptodate packages,
        # since those subcommands already make index requests.
